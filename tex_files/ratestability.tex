...
This follows from the fact that the random walk without drift, i.e., $\mu=\lambda$, has some unexpected behavior\footnote{See any good book on probability theory.}, and we know from~\cref{sec:queu-proc-as} that queueing systems and random walks are intimately related.
